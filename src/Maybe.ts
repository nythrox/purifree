...
Nothing.prototype[Symbol.iterator] = function* (): ThisType<never> {
  return (yield this) as never
}

Nothing.prototype[ofSymbol] = Maybe.of

Nothing.prototype.traverse = function <
  URI extends URIS,
  AP extends ApKind<any, any> = ApKind<URI, any>
>(
  of: ofAp<URI>,
...
Nothing.prototype['fantasy-land/traverse'] = function <
  URI extends URIS,
  AP extends ApKind<any, any> = ApKind<URI, any>
>(
  of: ofAp<URI>,
...
Nothing.prototype['fantasy-land/sequence'] = function <
  Ap extends ApKind<any, any>
>(
  this: Maybe<Ap>,
  of: ofAp<Ap['_URI']>
...
Nothing.prototype.sequence = function <Ap extends ApKind<any, any>>(
  this: Maybe<Ap>,
  of: ofAp<Ap['_URI']>
): Type<Ap['_URI'], ReplaceFirst<Ap['_A'], Maybe<Ap['_A'][0]>>> {
  return of(this) as any
